...
public class MortarActivityScopeTest {
  ...
  private void newProcess() {
    ...
    ObjectGraphService.inNewScope(builder, ObjectGraph.create(new MyModule()));
    MortarScope root = builder.build();
  ...
  @Ignore // No longer supported after service locator update
  ...
  @Ignore // No longer supported after service locator update
  @Test public void peerBundlersLoadSynchronouslyButThoseInChildScopesShouldWaitEvenInAFreshScope() {
    final MyBundler peerBundler = new MyBundler("bro");
    final MyBundler childBundler = new MyBundler("child");
    final MyBundler grandchildBundler = new MyBundler("grandchild");
